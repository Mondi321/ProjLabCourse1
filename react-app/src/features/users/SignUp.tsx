            ...
            >
                {({ handleSubmit, errors, isValid , dirty, isSubmitting}) => (
                    <Form className='formFields error' onSubmit={handleSubmit} autoComplete='off'>
                        <MyTextInput label='Display Name' name='displayName' placeholder='Enter your display name' />
                        ...
                        <Button disabled={!isValid || !dirty || isSubmitting} type='submit' className='formFieldButton' variant='warning'>Sign Up</Button>
                            {" "}
